...
"""
    ...
    with open('tangency_portfolio_app.py', 'w') as f:
        f.write(app_content)
    
    print("Created streamlit app: tangency_portfolio_app.py")
    print("To run the app, use the command: streamlit run tangency_portfolio_app.py")
